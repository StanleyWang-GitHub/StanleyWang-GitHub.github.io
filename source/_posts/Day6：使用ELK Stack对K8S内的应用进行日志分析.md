...
[Tomcat8下载链接](http://mirrors.tuna.tsinghua.edu.cn/apache/tomcat/tomcat-8/v8.5.49/bin/apache-tomcat-8.5.49.tar.gz)
```pwd /opt/src
[root@hdss7-200 src]# ls -l|grep tomcat
-rw-r--r-- 1 root root   9690027 Apr 10 22:57 apache-tomcat-8.5.49.tar.gz
[root@hdss7-200 src]# mkdir -p /data/dockerfile/tomcat && tar xf apache-tomcat-8.5.49.tar.gz -C /data/dockerfile/tomcat
[root@hdss7-200 src]# cd /data/dockerfile/tomcat && rm -fr apache-tomcat-8.5.49/webapps/*
```

### 简单配置tomcat
1. 关闭AJP端口

```vi /data/dockerfile/tomcat/apache-tomcat-8.5.49/conf/server.xml
...
```vi /data/dockerfile/tomcat/apache-tomcat-8.5.49/conf/logging.properties
...
ADD apache-tomcat-8.5.49/ /opt/tomcat
...
### 制作镜像并推送
```
[root@hdss7-200 tomcat]# docker build . -t harbor.od.com/base/tomcat:v8.5.49
...
Step 5 : ADD apache-tomcat-8.5.49/ /opt/tomcat
 ---> 460a5d0ef93b
...
[root@hdss7-200 tomcat8]# docker push harbor.od.com/base/tomcat:v8.5.49
...
v8.5.49: digest: sha256:407c6abd7c4fa5119376efa71090b49637d7a52ef2fc202f4019ab4c91f6dc50 size: 2409
```
## 改造dubbo-demo-web项目
略，直接使用tomcat分支
